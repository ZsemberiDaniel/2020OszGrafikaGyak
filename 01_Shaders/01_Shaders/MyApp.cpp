...
bool CMyApp::Init()
{
	...
	widthUniform = glGetUniformLocation(m_programID, "windowWidth");
	heightUniform = glGetUniformLocation(m_programID, "windowHeight");
...
void CMyApp::Render()
{
	...
	glUniform1f(widthUniform, windowWidth);
	glUniform1f(heightUniform, windowHeight);

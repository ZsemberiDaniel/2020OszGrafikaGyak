...
bool CMyApp::Init()
{
	...
	glBufferData(GL_ARRAY_BUFFER,	// az aktív VBO-ba töltsünk adatokat
		sizeof(fullCircleVert),		// ennyi bájt nagyságban
		fullCircleVert,	// errõl a rendszermemóriabeli címrõl olvasva
		GL_STATIC_DRAW);
	...
	glBufferData(GL_ARRAY_BUFFER,	// az aktív VBO-ba töltsünk adatokat
		sizeof(circleVert),		// ennyi bájt nagyságban
		circleVert,	// errõl a rendszermemóriabeli címrõl olvasva
		GL_STATIC_DRAW);
